...
<figure>
<img src="ai-agent.png" id="fig:aisetup" alt="[fig:aisetup]AI setup." /><figcaption aria-hidden="true"><span id="fig:aisetup" label="fig:aisetup">[fig:aisetup]</span>AI setup.</figcaption>
</figure>
...
<figure>
<img src="mopbot.png" id="fig:mopbotup" alt="[fig:mopbotup]Mopping Bot Setup." /><figcaption aria-hidden="true"><span id="fig:mopbotup" label="fig:mopbotup">[fig:mopbotup]</span>Mopping Bot Setup.</figcaption>
</figure>
...
<table>
<caption><span id="algo:table-drive-agent-function" label="algo:table-drive-agent-function"></span></caption>
<thead><tr><th>Table-Driven-Agent(<em>percept</em>)</th></tr></thead>
<tbody>
<tr><td>Static: <em>percepts</em>: a sequence. <em>table:</em> a table of actions, indexed by percept sequences fully specified.</td></tr>
<tr><td>percepts <span class="math inline">\(\gets\)</span> precepts <span class="math inline">\(\cup\)</span> <em>percept</em></td></tr>
<tr><td><em>action</em> <span class="math inline">\(\leftarrow\)</span> LOOKUP(<em>percept,table</em>)</td></tr>
<tr><td>Return <em>action</em></td></tr>
</tbody>
</table>
...
<tbody>
<tr>
<th style="text-align: left;"><strong>Simple Reflex</strong></th>
...
<th style="text-align: left;"><p>Infant:</p>
<ul>
...
<tr class="even">
<th style="text-align: left;"><strong>Model-Based Reflex</strong></th>
<th style="text-align: left;"><ul>
<li><p>Passive</p></li>
...
<th style="text-align: left;"><p>Adult:</p>
<ul>
