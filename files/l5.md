...
|:--:|
| <b id="fig:CSP-backtrack-naive" label="fig:CSP-backtrack-naive" > *Board state at various steps of naive Backtracking Search.* </b>|
...
|:--:|
| <b id="fig:improved:backtrack" label="fig:improved:backtrack" > *Board state at various steps of improved BacktrackingSearch* </b>|
...
|:--:|
| <b id="fig:infer1" label="fig:infer1" > *Board state at various steps of improved BacktrackingSearch with Inference* </b>|
...
|:--:|
| <b id="fig:infer2" label="fig:infer2" > *Board state at various steps of improved BacktrackingSearch with Inference* </b>|
...
- <ins>Constraint 1:</ins>NOATTACK($x_1,x_2$)
  ...
  - Observation from Figure <a href="#fig:infer1">4</a> :
    $x_1=1 \Rightarrow x_2 \notin \{1,2,3\} \Rightarrow x_2=4$

- <ins>Constraint 2:</ins>NOATTACK($x_1,x_3$)

  - Observation from <a href="#fig:infer1">4</a>:
    $x_1=1 \Rightarrow x_3 \notin \{2,4\}$
