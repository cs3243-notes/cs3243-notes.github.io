...
-   Leave the room _B_ when no dirt is detected.
...
$\varphi(\tau)=$ _true_ or _false_. But, this approach will not work,
...
<center><bold> Table</bold>: Truth table for statement $\varphi ≡ (\alpha \vee p) \wedge (\neg{p} \vee \beta)$</center>
